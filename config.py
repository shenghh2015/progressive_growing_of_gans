...
# Dataset (choose one).
desc += '-mri';            dataset = EasyDict(tfrecord_dir='tfr'); train.mirror_augment = True
...
#desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}; sched.G_lrate_dict = {256: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
desc += '-preset-v2-2gpus'; num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 128, 16: 128, 32: 64, 64: 64, 128: 16, 256: 8}; sched.G_lrate_dict = {4: 0.0003, 8: 0.0003, 16: 0.0006, 32: 0.0006, 64: 0.0006, 128: 0.0003, 256: 0.0003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); sched.D_lrate_dict = {4: 0.0003, 8: 0.0003, 16: 0.0006, 32: 0.0006, 64: 0.0006, 128: 0.0003, 256: 0.0003}  ; train.total_kimg = 12000
